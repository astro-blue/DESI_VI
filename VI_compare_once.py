...
#VI_truth_file = '/Users/tlan/Dropbox/To_share/DESI_VI_truth/truth_table_ELG_v1.2.csv'
...
VI_truth_file = '/Users/tlan/Dropbox/To_share/DESI_VI_truth/truth_table_ELG_v1.1_latest_change.csv'



# Define the VI file you want to compare, and the directory you find it in, and the output directory you want to send it to
VI_file    =  'SAE.csv'   # We remove .csv and add e.g. _z.png to print plots for this file
VI_dir     = '/Users/tlan/Dropbox/Astro_Research/Projects_plots_notes/2020_DESI_visual_inspect/VI_v1_individual/ELG/individual_inspectors/problem/'
#VI_dir     = '/Users/uqtdavi1/Documents/programs/DESI/SV/VI_files/SV0/QSO/'
output_dir = VI_dir+'VI_check_0910/'  # The directory in which we'll put the output.  If it doesn't exist the program will make it.
