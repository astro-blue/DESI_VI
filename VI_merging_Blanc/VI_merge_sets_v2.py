...
if on_nersc:  
  ...
  VI_dir = os.environ['HOME']+'/projects/VI_files/SV1/LRG/'
else:
...
subset = "_26_"  # YOU WANT TO CHANGE THIS EACH TIME, it defines "pattern" below.  Set to "" to use all.
output_name = "desi-vi_LRG_tile"+tiles[0]+"_nightdeep"+subset+"merged"
